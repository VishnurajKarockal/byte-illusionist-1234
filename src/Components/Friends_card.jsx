...
const Friends_card = (item) => {
  ...
  const handleAddFriend = () => {
    // Dispatch addFriend action with friend data
        ...
        <Card maxW="sm">
          ...
          <CardFooter>
            <ButtonGroup spacing="2">
              <Button onClick={handleAddFriend} variant="solid" colorScheme="blue">
                Add Friend
              </Button>
              <Button onClick={handleRemoveFriend} variant="ghost" colorScheme="blue">
                Remove Friend
              </Button>
            </ButtonGroup>
          </CardFooter>
